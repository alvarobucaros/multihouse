...
function borra($data) {
    ...
    if (mysqli_errno($con) === 1451) {
        echo 'Err. Este propietario Tiene facturación asociada, No se puede borrar';
        return;
    } else {
        echo 'Ok';
    }
...
// (propietarioId,propietarioEmpresaId,propietarioNombre,propietarioCedula,propietarioTelefonos,propietarioDireccion,propietarioCorreo,propietarioActivo)
