    ...
    { 
       ...
       { 
        $query = "SELECT  ServicioId, servicioEmpresaId, ServicioCodigo, ServicioDetalle, 
		 ...
		 ServicioPPvalor, ServicioActivo, ServicioAmbito, 
                 CASE ServicioAmbito WHEN 'G' THEN 'Grupo' ELSE 'Todos' END nomcase, clasificacionCodigo AS servicioClasificacionId
		 FROM contaservicios 
...
SELECT  ServicioId, servicioEmpresaId, ServicioCodigo, ServicioDetalle, 
		 ...
		 servicioMoraValor, ServicioCuentaDB, ServicioCuentaCR, ServicioPPporcentaje, 
		 ServicioPPvalor, ServicioActivo, ServicioAmbito,
                 CASE ServicioAmbito WHEN 'G' THEN 'Grupo' ELSE 'Todos' END nomcase, '' AS servicioClasificacionId
		 FROM contaservicios 		 
