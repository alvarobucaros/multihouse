...
function leeRegistros($data) {
    ...
    $empresa = $data->empresa;
    {
        $query = "SELECT  terceroId, terceroEmpresaId, terceroNombre, terceroIdenTipo, terceroIdenNumero, " .
                ...
                " terceroCiudad FROM contaterceros WHERE terceroEmpresaId = " . $empresa . " ORDER BY terceroNombre ";
...
function actualiza($data) {
    ...
    $terceroCiudad = $data->terceroCiudad;

    if ($terceroId == 0) {
        $query = "INSERT INTO contaterceros(terceroEmpresaId, terceroNombre, terceroIdenTipo, ";
        $query .= " terceroIdenNumero, terceroDireccion, terceroTelefonos, terceroCorreo, terceroTwiter,  ";
        $query .= " terceroFacebook, terceroComentario, tercero_codigo, terceroActivo, terceroRegimen,  ";
        $query .= " terceroContribuyente, terceroCiudad)";
        $query .= "  VALUES ('" . $terceroEmpresaId . "', '" . $terceroNombre . "', '" . $terceroIdenTipo .
                "', '" . $terceroIdenNumero . "', '" . $terceroDireccion . "', '" . $terceroTelefonos . 
                "', '" . $terceroCorreo . "', '" . $terceroTwiter . "', '" . $terceroFacebook . 
                "', '" . $terceroComentario . "', '" . $tercero_codigo . "', '" . $terceroActivo . 
                "', '" . $terceroRegimen . "', '" . $terceroContribuyente . "', '" . terceroCiudad. "')";
        mysqli_query($con, $query);
        echo 'Ok';
    } else {
        $query = "UPDATE contaterceros  SET terceroEmpresaId = '" . $terceroEmpresaId . "', terceroNombre = '" . 
                $terceroNombre . "', terceroIdenTipo = '" . $terceroIdenTipo . "', terceroIdenNumero = '" .
                $terceroIdenNumero . "', terceroDireccion = '" . $terceroDireccion . "', terceroTelefonos = '" . 
                $terceroTelefonos . "', terceroCorreo = '" . $terceroCorreo . "', terceroTwiter = '" . 
                $terceroTwiter . "', terceroFacebook = '" . $terceroFacebook . "', terceroComentario = '" . 
                $terceroComentario . "', tercero_codigo = '" . $tercero_codigo . "', terceroActivo = '" . 
                $terceroActivo . "', terceroRegimen = '" . $terceroRegimen . "', terceroContribuyente = '" . 
                $terceroContribuyente . "', terceroCiudad = '" . $terceroCiudad ."' WHERE terceroId = " . $terceroId;
        mysqli_query($con, $query);
        echo 'Ok';
    }
}
...
function exportaXls($data) {
    ...
    $query = "SELECT  terceroId, terceroEmpresaId, terceroNombre, terceroIdenTipo, terceroIdenNumero, " .
            " terceroDireccion, terceroCiudad , terceroTelefonos, terceroCorreo, terceroTwiter, terceroFacebook, " .
            " terceroComentario, tercero_codigo, terceroActivo, terceroRegimen, terceroContribuyente" .
...
function unRegistro($data) {
    ...
    $terceroId = $data->terceroId;
    $query = "SELECT  terceroId, terceroEmpresaId, terceroNombre, terceroIdenTipo, terceroIdenNumero, ";
        $query .= " terceroDireccion, terceroTelefonos, terceroCorreo, terceroTwiter, terceroFacebook, ";
        $query .= " terceroComentario, tercero_codigo, terceroActivo, terceroRegimen, terceroContribuyente,  " .
            " terceroCiudad FROM contaterceros  WHERE terceroId = " . $terceroId .
            " ORDER BY terceroNombre ";
    $result = mysqli_query($con, $query);
    $arr = array();
    if (mysqli_num_rows($result) != 0) {
