...

{
    ...
    {     
        ...
        $nota2= 'Instalacion correcta'; //<p>Ya se hizo una instalacion en este servidor con esta base de datos</p>';
...
graba($file," ");
graba($file,"  CREATE TABLE IF NOT EXISTS ".$BaseDatos .".mm_listactrl ( "); 
graba($file,"	listactrl_id int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',  ");
graba($file,"	listactrl_empresa int(11) DEFAULT NULL,  ");
graba($file,"	listactrl_codigo VARCHAR(10) NULL , "); 
graba($file,"	listactrl_estado CHAR(1) NULL , ");
graba($file,"	listactrl_llamado int(11) DEFAULT NULL,  ");
graba($file,"  PRIMARY KEY (listactrl_id) ) ");
graba($file,"   ENGINE=InnoDB AUTO_INCREMENT=1    DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;   ");               
graba($file,"	    ");
