<div class="container "  ng-controller="mainController">
        <h3 class="text-left">{{form_imprimeCtaMov}}</h3>
       ...
       <div class="col-md-8 col-md-offset-1">
            ...
            <form class="form-horizontal alert alert-mm color-palette-set" name="formato" id="idForm"
                ...
                <div class="form-group">
                    <label class="milabel col-md-3" for="v">{{form_desdePeriodo}}</label>
                    <div class="col-md-2">
                ...
                <div class="form-group">
                    <label class="milabel col-md-3" for="hastaPeriodo">{{form_hastaPeriodo}}</label>
                    <div class="col-md-2">
                        <input type="text" class="mitexto" id="hastaPeriodo" name="hastaPeriodo"
                           ng-model="hastaPeriodo"  />
                    </div>
                </div>   
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="form-group">
                        <div class="col-md-2">
                            ...
                            ng-click="imprimeCtaMvtos()" id="continua">{{form_btnContinua}}</button>
                        </div>  
                    </div>
                </div> 
                <div class="form-group" style='display: none'>                   
                    <input type="text"  id="control" ng-model="control"  value="CMV" />
