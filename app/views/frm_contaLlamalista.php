    ...
    <div class="container "  ng-controller="mainController">
        ...
        <nav class="navbar navbar-default  col-md-10 col-md-offset-1 navbar-mm">
            <div class="form-group">
                ...
                <div class="col-md-2"> 
                    <input type="text" style="width: 20px; text-align: center;"  id='numeroLlamado'  ng-model="numeroLlamado"
                           ng-change="nuevaLista()">
                    <input type="text" style="width: 60px; text-align: center; background-color: gainsboro"  
                           id='nombreLlamado' readonly="yes"  ng-model="nombreLlamado">
                </div>
                <div class="col-md-1 "  ng-class="semaforo"> 
                    <input type="text" style="width: 50px; background-color: gainsboro; text-align: center;"  id='nroAsisten' 
                       ng-model="nroAsisten"  ng-style="{'background-color':  {red: 'red', green: 'green'}[ color ]}" > 
                </div>
                <div class="col-md-3">
                <div class="col-md-1">                    
                    <label for="semaforo"  style="width: 40px; text-align:  left" > {{form_numeroTotal}} </label>
                </div>
                    <input type="text" style="width: 40px; text-align: center;"  id='semaforo' ng-model="semaforo"  >
            </div>
            </div>
        </nav>
        <div> 
        ...
        <div class="col-md-10">
            ...
            <div class="table-responsive">
                <table class="table table-hover tablex">
                    ...
                    <td id="td1" ng-show="td1"> <input type="checkbox" ng-change="cuentaLista($index,1)" ng-model="detail.lista_asiste1" ng-true-value="1" ng-false-value="0"></td>
                    <td id="td2" ng-show="td2"> <input type="checkbox" ng-change="cuentaLista($index,2)" ng-model="detail.lista_asiste2" ng-true-value="1" ng-false-value="0"></td>
                    <td id="td3" ng-show="td3"> <input type="checkbox" ng-change="cuentaLista($index,3)" ng-model="detail.lista_asiste3" ng-true-value="1" ng-false-value="0"></td>
                    <td id="td4" ng-show="td4"> <input type="checkbox" ng-change="cuentaLista($index,4)" ng-model="detail.lista_asiste4" ng-true-value="1" ng-false-value="0"></td>
                    <td id="td5" ng-show="td5"> <input type="checkbox" ng-change="cuentaLista($index,5)" ng-model="detail.lista_asiste5" ng-true-value="1" ng-false-value="0"></td>
                    <td id="td6" ng-show="td6"> <input type="checkbox" ng-change="cuentaLista($index,6)" ng-model="detail.lista_asiste6" ng-true-value="1" ng-false-value="0"></td>
...
<script src="controller/ctrls/contallamalista.ctrl.js" type="text/javascript"></script>
