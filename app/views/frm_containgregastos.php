        ...
        <div class="col-md-8 col-md-offset-1">
            ...
            <form class="form-horizontal alert alert-mm color-palette-set" name="formato" id="idForm"
                ...
                <div class="form-group">
                   ...
                   <div class="col-md-6">
                    <input type="date" width="12" class="form-control mitexto fa fa-calendar fa-lg" id="ingastoFecha" name="ingastoFecha"
                         ng-model="registro.ingastoFecha" required Placeholder="{{form_PhingastoFecha}}" 
                ...
                <div class="form-group">
                   ...
                   <label>
                      <input type="radio" name ="ingastotipo" ng-model="registro.ingastotipo" value="0" >{{form_ingastotipo40}}
                   </label>
                   <label>
                      <input type="radio" name ="ingastotipo" ng-model="registro.ingastotipo" value="1" >{{form_ingastotipo41}}
                   </label>
                    </div>
                </div> 
                ...
                <div class="form-group">
                   ...
                   <div class="col-md-6">
                    <input type="text" class="form-control mitexto" id="ingastodetalle" name="ingastodetalle"
                ...
                <div class="form-group">
                    ...
                    <div class="btn-group  col-md-6"  data-toggle="buttons">
                   <label>
                      <input type="radio" name ="ingastocontabiliza" ng-model="registro.ingastocontabiliza" value="0" >{{form_ingastocontabiliza80}}
                   </label>
                   <label>
                      <input type="radio" name ="ingastocontabiliza" ng-model="registro.ingastocontabiliza" value="1" >{{form_ingastocontabiliza81}}
                   </label>
                    </div>
                </div> 
        ...
        <div class="col-md-10">
            ...
            <div class="table-responsive">
                <table class="table table-hover tablex">
                    ...
                    <td>{{detail.ingastovalor}}</td>
                    <td>{{detail.ingastocontabiliza}}</td>
                    <td>
