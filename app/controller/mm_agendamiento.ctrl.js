 ...
 //alert('crea'+data);           
    ...
    $scope.updateTema = function (registro4) {
        var datos = $scope.registro4.tema_id+'||'+$scope.agenda_id+'||'+ $scope.empresa+'||'+
                    ...
                    $scope.registro4.tema_tipo+'||'+$scope.registro4.tema_responsable+'|| ||'+
                    $scope.registro4.tema_fechaAsigna+'|| ||'+$scope.registro4.tema_estado+'||0||'+$scope.registro4.tema_orden;  
...
//Notice: Undefined property: stdClass::$agenda_id in C:\wamp\www\multimeeting\app\modulos\mod_mm_agendamiento.php on line <i>503</i></th></
