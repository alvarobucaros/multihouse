...
//    function importaXls(datos){
//           myempre = $('#e').val();
//           cadena = '0||'+myempre+ '||'+datos[0]+ '||'+datos[1]+ '||'+datos[2]+ '||'+datos[3]+ '||'+datos[4]+ '||'+
//                   datos[5]+ '||'+datos[6]+ '||'+datos[7]+ '||'+datos[8]+ '||'+datos[9]+ '||A';
//          // alert (cadena);
//            $http.post('modulos/mod_mm_inmuebles.php?op=xls',{'op':'xls', 'cadena':cadena}).success(function(data){
//            alert(data);
//
//    });  
//}
