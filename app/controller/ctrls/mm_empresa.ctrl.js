...
app.controller('mainController',['$scope','$http', function($scope,$http){
    ...
    $scope.form_empresa_autentica80 = 0;
    $scope.form_empresa_autentica81 = 1;
    $scope.form_empresa_autentica82 = 2;
    ...
    $scope.form_empresa_versionPrd = 'VERSIONPRD';
    $scope.form_empresa_versionBd = 'VERSIONBD';
    $scope.form_empresa_clave = 'CLAVE';
    $scope.form_empresa_email = 'EMAIL';
    $scope.form_empresa_registrsoXpagina = 'REGISTRSOXPAGINA';
    $scope.form_empresa_diasTrabaja = 'DIASTRABAJA';
    $scope.form_empresa_horarioInicio = 'HORARIOINICIO';
    $scope.form_empresa_horarioTermina = 'HORARIOTERMINA';
    $scope.form_empresa_intervaloCalendario = 'INTERVALOCALENDARIO';
    $scope.form_empresa_FormatoActa = 'FORMATOACTA';
    $scope.form_empresa_cresidencial = 'CRESIDENCIAL';
    $scope.form_empresa_ctrl = 'CTRL';
    ...
    $scope.form_Phempresa_cresidencial = 'Digite cresidencial';
    $scope.form_Phempresa_ctrl = 'Digite ctrl';
...
$scope.exporta = function(){
   ...
   if (valor == true) {
    ...
    $scope.updateInfo =function(info)
    {
        ...
        if($('#empresa_cresidencial').val()===''){er+='falta cresidencial\n';}
        if($('#empresa_ctrl').val()===''){er+='falta ctrl\n';}
        if (er==''){
...
// >>>>>>>   Creado por: Alvaro Ortiz Castellanos   Sunday,Dec 11, 2022 3:40:35   <<<<<<< 
