...
app.controller('mainController',['$scope','$http', function($scope,$http){
    ...
    function getInfo(){
        ...
        $http.post('modulos/mod_contaloadlogos.php?op=lo',{'op':'lo','empresa':empresa}).success(function(data){
        data = 'reports/images/'+data;
        $scope.imgLogo = data;
        });
        $http.post('modulos/mod_contaloadlogos.php?op=av',{'op':'av','empresa':empresa, 'usuario':usuario}).success(function(data){
        data = 'photo/'+data;
