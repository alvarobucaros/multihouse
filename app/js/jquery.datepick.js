 	...
 	alert('Selected ' + dates);
		...
		regionalOptions: { // Available regional settings, indexed by language/country code
			'': { // Default regional settings - English/US
				...
				prevText: '&lt;Ante',
				prevStatus: 'Va al mes anterior',
				prevJumpText: '&lt;&lt;',
				prevJumpStatus: 'Ve el año anterior',
				nextText: 'Sgnte&gt;',
				nextStatus: 'Va al, siguiente mes',
				nextJumpText: '&gt;&gt;',
				nextJumpStatus: 'Va al siguiente año',
				currentText: 'Actual',
				currentStatus: 've el mes actual',
				todayText: 'Hoy',
				todayStatus: 've el dia del ems',
				clearText: 'Borra',
				clearStatus: 'Borra fechas',
				closeText: 'Cierra',
				closeStatus: 'Cierra almanaque',
				yearStatus: 'Cambia año',
				earlierText: '&#160;&#160;▲',
				laterText: '&#160;&#160;▼',
				monthStatus: 'Cambia mes',
				weekText: 'Wk',
				weekStatus: 'Semana del año',
				dayStatus: 'Selecciona DD, M d, yyyy',
				defaultStatus: 'Seleccione uan fecha',
				isRTL: false
			}
		},
