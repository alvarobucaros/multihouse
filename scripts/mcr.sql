...
INSERT INTO `contacomprobantes` VALUES (1,1,'01','SALDOS INICIALES',0,'A','Movimiento de apertura de cuentas');
...
--
-- Dumping data for table `containgregastos`
--

LOCK TABLES `containgregastos` WRITE;
/*!40000 ALTER TABLE `containgregastos` DISABLE KEYS */;
INSERT INTO `containgregastos` VALUES (1,1,'2018-01-01','201801','A',0,'SALDOS INICIALES','0',0.00,'N');
/*!40000 ALTER TABLE `containgregastos` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `contaservicios` VALUES (1,6,'ANTI','Anticipos','2000','2000-01-01','2000-01-01',0.00,3,'C','N',0.00,0.00,'1','2',0.00,0.00,'S','G',0);
