...
--
-- Host: localhost
-- Database:atominge_mmeetingT2
-- Script date Wednesday,Jan 30, 2019 1:22:18
-- by AtomIngenieria sas

--
-- Crea Base de datos
--
CREATE DATABASE atominge_mmeetingT2 CHARACTER SET utf8 COLLATE utf8_spanish_ci;
USE atominge_mmeetingT2; 

--
-- Table structure for table mm_instala
--
   DROP TABLE IF EXISTS atominge_mmeetingT2.mm_instala;
	CREATE TABLE IF NOT EXISTS  atominge_mmeetingT2.mm_instala ( 
   ...
   INSERT INTO atominge_mmeetingT2.mm_instala (servidor,basedatos, usuario, password, estado) VALUES ( 'localhost','atominge_mmeetingT2','root','123','1');
...
--
   DROP TABLE IF EXISTS atominge_mmeetingT2.mm_accesos;
   CREATE TABLE IF NOT EXISTS atominge_mmeetingT2.mm_accesos (  
...
--
   DROP TABLE IF EXISTS atominge_mmeetingT2.mm_agendaanexos;
   CREATE TABLE IF NOT EXISTS atominge_mmeetingT2.mm_agendaanexos ( 
   ...
   CREATE TABLE IF NOT EXISTS atominge_mmeetingT2.mm_agendainvitados (  invitado_id int(11) NOT NULL AUTO_INCREMENT,  
   ...
   CREATE TABLE IF NOT EXISTS atominge_mmeetingT2.mm_agendamiento ( 
   ...
   CREATE TABLE IF NOT EXISTS atominge_mmeetingT2.mm_agendapendientes ( 
  ...
  SELECT 'Tabla mm_agendapendientes creada'; 
   ...
   CREATE TABLE IF NOT EXISTS atominge_mmeetingT2.mm_agendatemas ( 
   ...
   CREATE TABLE IF NOT EXISTS atominge_mmeetingT2.mm_asistentes ( 
   ...
   CREATE TABLE IF NOT EXISTS atominge_mmeetingT2.mm_cargadocumentos ( 
   ...
   CREATE TABLE IF NOT EXISTS atominge_mmeetingT2.mm_comites ( 
   ...
   CREATE TABLE IF NOT EXISTS atominge_mmeetingT2.mm_empresa ( 
   ...
   DELETE FROM atominge_mmeetingT2.mm_empresa WHERE empresa_id > 0; 
    
   INSERT INTO atominge_mmeetingT2.mm_empresa (empresa_id, empresa_nombre, empresa_nit, empresa_web, empresa_direccion, 
...
'7:00', '19:00', 'M', 'Estandard', 'N','wefB875s13846s12518refd8624A12'); 
   ...
   CREATE TABLE IF NOT EXISTS atominge_mmeetingT2.mm_grupos ( 
  ...
  SELECT 'Tabla mm_grupos creada'; 
   ...
   CREATE TABLE IF NOT EXISTS atominge_mmeetingT2.mm_inmuebles ( 
  ...
  CREATE TABLE IF NOT EXISTS atominge_mmeetingT2.mm_invitados_comite ( 
  ...
  SELECT 'Tabla mm_invitados_comite creada'; 
   ...
   CREATE TABLE IF NOT EXISTS atominge_mmeetingT2.mm_menu ( 
   ...
   CREATE TABLE IF NOT EXISTS atominge_mmeetingT2.mm_parametros ( 
  ...
  CREATE TABLE IF NOT EXISTS atominge_mmeetingT2.mm_perfiles ( 
   ...
   DELETE FROM atominge_mmeetingT2.mm_perfiles WHERE perfil_id > 0; 
	 
 
   INSERT INTO atominge_mmeetingT2.mm_perfiles (perfil_empresa, perfil_codigo, 
			perfil_nombre, perfil_activo) VALUES ('1', '1', 'GENERAL', 'A') ; 
 
   SELECT 'perfil general creado'; 
 
   CREATE TABLE IF NOT EXISTS atominge_mmeetingT2.mm_popup ( 
   ...
   CREATE TABLE IF NOT EXISTS atominge_mmeetingT2.mm_reservasalon ( 
   ...
   CREATE TABLE IF NOT EXISTS atominge_mmeetingT2.mm_salones ( 
   ...
   CREATE TABLE IF NOT EXISTS atominge_mmeetingT2.mm_temasgrales ( 
   ...
   CREATE TABLE IF NOT EXISTS atominge_mmeetingT2.mm_temp01 ( 
  ...
  CREATE TABLE IF NOT EXISTS atominge_mmeetingT2.mm_tipoacta ( 
   ...
   CREATE TABLE IF NOT EXISTS atominge_mmeetingT2.mm_usuariomenu ( 
   ...
   CREATE TABLE IF NOT EXISTS atominge_mmeetingT2.mm_usuarios ( 
  ...
  DELETE FROM atominge_mmeetingT2.mm_usuarios WHERE usuario_id > 0; 
 
   INSERT INTO atominge_mmeetingT2.mm_usuarios (usuario_nombre, usuario_empresa, usuario_email, 
   ...
   CREATE TABLE IF NOT EXISTS atominge_mmeetingT2.mn_privilegios ( 
   ...
   CREATE TABLE IF NOT EXISTS atominge_mmeetingT2.mm_llamalista ( 
